! function(e) {
	...
	e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure Area and Energy Output">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Measure Area and Energy Output</h3> <ul class=tasks> <a href=# class="js-start start">Create a new measurement</a> </ul> </div> <div class=js-measuringprompt> <h3>Measure Area and Energy Output</h3> <p class=js-starthelp>Start creating a measurement by adding points to the map</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancel</a></li> <li><a href=# class="js-finish finish">Finish measurement</a></li> </ul> </div> </div> '
}, function(e, t, r) {
	...
	e.exports = '<h3>Area measurement</h3> <p><strong>Area:</strong> {{ model.areaDisplay }}</p> <p><strong>Power Output:</strong> {{ Math.round(model.area*0.001932)}} gWh/year</p> <p><strong>Cost (approx):</strong> ₹{{ Math.round(model.area*1.52*2471).toLocaleString("arab")}}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this area</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}]);
